          ...
          <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
            <div className="relative">
              <dt>
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-indigo-600">Fortalezas Profesionales</p>
              </dt>
            ...
            <div className="relative">
              <dt>
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-indigo-600">Valores Personales</p>
              </dt>
              <dd className="mt-2 ml-16 text-base text-white">
              ...
              {skills.map((skill, index) => (
                <div key={index} className="relative">
                  <dt>
                    ...
                    <p className="ml-16 text-lg leading-6 font-medium text-indigo-500">{skill.name}</p>
                  </dt>
                  <dd className="mt-2 ml-16 text-base text-white">{skill.description}</dd>
                </div>
              ))}
            </dl>
          </div>
