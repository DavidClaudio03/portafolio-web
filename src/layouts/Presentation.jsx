    ...
    <section className="pt-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
      ...
      <PantallaFlotante isOpen={isPantallaFlotanteOpen} onClose={closePantalla}>
        ...
        <div className="lg:text-center">
          <h2 className="text-base text-indigo-600 font-semibold tracking-wide uppercase">Visión</h2>
          <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
            Visión Profesional
          </p>
          <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
            Mi objetivo es convertirme en un desarrollador Full Stack Senior, con una especialización 
            emergente en ciberseguridad y hacking ético.
          </p>
        </div>
          ...
          <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
            <div className="relative">
              <dt>
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Aspiraciones</p>
              </dt>
              <dd className="mt-2 ml-16 text-base text-gray-500">
                <ul className="list-disc pl-5 space-y-2">
                  <li>Dominar múltiples tecnologías de desarrollo</li>
                  <li>Desarrollar software innovador con integración de Inteligencia Artificial</li>
            ...
            <div className="relative">
              <dt>
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Retos Profesionales</p>
              </dt>
              <dd className="mt-2 ml-16 text-base text-gray-500">
                <ul className="list-disc pl-5 space-y-2">
                  <li>Desarrollo de software con Inteligencia Artificial</li>
                  <li>Implementación de soluciones de seguridad informática</li>
