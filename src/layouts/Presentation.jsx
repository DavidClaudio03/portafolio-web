...
function Presentation() {
  ...
  return (
    <section className="w-full px-4 sm:px-6 lg:px-8 ">
      <AnimationBody />
      <div className="max-w-7xl h-screen mx-auto pt-10 relative overflow-hidden py-10">
        {/* <NavBar /> */}
         ...
         shadow-[2px_2px_0_#fff,
              ...
              <div className="mt-4 flex flex-col md:flex-row md:space-x-3 space-y-3 md:space-y-0">
                ...
                <button
                  ...
                  className="w-full md:w-auto flex font-medium font-bold justify-center gap-2 items-center mx-auto shadow-xl text-gay-50 text-xs sm:text-sm lg:text-base bg-green-500 backdrop-blur-md isolation-auto border-green-100 before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-left-full before:hover:left-0 before:rounded-full before:bg-emerald-500 hover:text-gray-50 before:-z-10 before:aspect-square before:hover:scale-150 before:hover:duration-700 relative z-10 px-2 py-1 sm:px-3 sm:py-1 lg:px-4 lg:py-2 overflow-hidden border-2 rounded-md group"
                >
                  Vision
