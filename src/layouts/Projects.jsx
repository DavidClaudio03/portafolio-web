...
import gamerfest2025 from "../image/gamerfest2025.png";
  ...
  const projects = [
    {
      ...
      description:
        "Development of a geospatial solution for a Decentralized Autonomous Government, demonstrating skills in web development and database management.",
      image: geoportal,
      link: "https://www.salcedo.gob.ec/portalciudad/geo",
    },
    {
      title: "Gamer Fest 2025",
      description:
        "Website management for a video game event, demonstrating the ability to deliver functional and attractive solutions.",
      image: gamerfest2025,
      link: "https://gamerfestespel.com/",
    },
    {
      title: "Web GamerFest 2024",
      description:
        "Website management for a video game event, demonstrating the ability to deliver functional and attractive solutions.",
      image: gamerfest,
    ...
    },
    {
      ...
      description:
        "Development of a school management platform using Odoo, focused on academic and administrative management.",
      image: education,
  ...
  return (
    <section id="projects" className="py-2">
      <div className="py-2 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="">
          <h2 className="reveal-rotate text-base text-purple-500 font-semibold tracking-wide">
            Projetcs
          </h2>
          ...
          <p className="reveal-right mt-4 text-base text-white">
            These projects demonstrate my ability to develop innovative and
            ...
            {projects.map((project, index) => (
              <div key={index} className="relative py-4">
                <dt>
                  ...
                  <p className="reveal-fade text-lg leading-6 font-medium text-purple-500">
                    {project.title}
                  </p>
                </dt>
                <dd className="reveal-fade mt-2 text-sm text-gray-50">
                  {project.description}
                </dd>
              </div>
            ))}
      ...
      <PantallaFlotante
        isOpen={isPantallaFlotanteOpen}
        onClose={closePantalla}
      ></PantallaFlotante>
    </section>
  );
}
